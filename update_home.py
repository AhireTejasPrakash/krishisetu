...
new_home = """import { Link } from 'react-router-dom'
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-12 pb-16">
      ...
      {/* Interactive Ticker */}
      <div className="w-full bg-green-900 text-green-100 py-2 overflow-hidden whitespace-nowrap text-sm font-medium">
      ...
      <section className="pt-4 md:pt-8 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/crop-planning" className="btn-primary text-base px-8 py-3 w-full sm:w-auto">
              {t('hero.ctaPrimary')}
            </Link>
